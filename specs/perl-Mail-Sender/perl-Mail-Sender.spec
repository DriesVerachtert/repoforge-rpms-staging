...
%doc %{_mandir}/man3/Mail::Sender::CType::Ext.3pm*
%doc %{_mandir}/man3/Mail::Sender::CType::Win32.3pm*
%dir %{perl_vendorlib}/Mail/
%{perl_vendorlib}/Mail/Sender/
%{perl_vendorlib}/Mail/Sender.pm

%changelog
* Tue Jun 27 2017 Dries Verachtert <dries.verachtert@dries.eu> - 0.903-1
- Updated to release 0.903.
